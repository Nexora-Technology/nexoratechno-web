    ...
    <>
      ...
      <section className="section">
        <div className="container">
          ...
          >
            <div className="cases-grid" key={activeService}>
              {loading ? (
      ...
      <style>{`
        ...
        .js .stagger-wrap:not(.in) .cases-grid > * { opacity: 0; }
        .js .stagger-wrap.in .cases-grid > * {
        ...
        @media (prefers-reduced-motion: reduce) {
          .js .stagger-wrap:not(.in) .cases-grid > *,
          .js .stagger-wrap.in .cases-grid > * { opacity: 1; animation: none; }
        }
